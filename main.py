...
from __future__ import division   #版本之间转化所使用的
import random
import functools #functools 是 Python 中的高阶函数
#functools 是 Python 中很简单但也很重要的模块，主要是一些 Python 高阶函数相关的函数。 该模块的内容并不多，看官方文档 也就知道了。
...
_rint = functools.partial(random.SystemRandom().randint, 0) #偏函数
